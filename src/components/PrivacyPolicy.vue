<template>
  <div class="w-2/3 mx-auto">
    <h2 class="text-4xl text-center pt-12">Datenschutzerklärung</h2>
    <p class="pt-12">
      Diese Datenschutzerklärung klärt Sie über die Art, den Umfang und Zweck der Verarbeitung von personenbezogenen Daten (nachfolgend kurz „Daten“) im Rahmen der Erbringung unserer Leistungen sowie innerhalb unseres Onlineangebotes und der mit ihm verbundenen Webseiten, Funktionen und Inhalte sowie externen Onlinepräsenzen, wie z.B. unser Social Media Profile auf (nachfolgend gemeinsam bezeichnet als „Onlineangebot“). Im Hinblick auf die verwendeten Begrifflichkeiten, wie z.B. „Verarbeitung“ oder „Verantwortlicher“ verweisen wir auf die Definitionen im Art. 4 der Datenschutzgrundverordnung (DSGVO).
      <br>
      <br>
    </p>
    <h3 class="text-3xl py-4">Verantwortlicher</h3>
    <p>
      <span>
        {{$site.pages[0].frontmatter.site_infos.title}}
        <br>
        {{$site.pages[0].frontmatter.site_infos.owner}}
        <br>
        {{$site.pages[0].frontmatter.site_infos.adress}}
        <br>
        {{$site.pages[0].frontmatter.site_infos.plz}}
        <br>
        <br>
        Telefon: {{$site.pages[0].frontmatter.site_infos.phone}}
        <br>
        E-Mail: {{$site.pages[0].frontmatter.site_infos.email}}
      </span>
    </p>
    <h3 class="text-3xl py-4">Arten der verarbeiteten Daten</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Kategorien betroffener Personen</h3>
    <p>
      Besucher und Nutzer des Onlineangebotes (Nachfolgend bezeichnen wir die betroffenen Personen zusammenfassend auch als „Nutzer“).
      <br>
    </p>
    <h3 class="text-3xl py-4">Zweck der Verarbeitung</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Verwendete Begrifflichkeiten</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Maßgebliche Rechtsgrundlagen</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Sicherheitsmaßnahmen</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Übermittlungen in Drittländer</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Rechte der betroffenen Personen</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Widerrufsrecht</h3>
    <p>Sie haben das Recht, erteilte Einwilligungen mit Wirkung für die Zukunft zu widerrufen.</p>
    <h3 class="text-3xl py-4">Widerspruchsrecht</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Cookies und Widerspruchsrecht bei Direktwerbung</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Löschung von Daten</h3>
    <p>
    ...
    <h3 class="text-3xl py-4">Änderungen und Aktualisierungen der Datenschutzerklärung</h3>
    <p>Wir bitten Sie sich regelmäßig über den Inhalt unserer Datenschutzerklärung zu informieren. Wir passen die Datenschutzerklärung an, sobald die Änderungen der von uns durchgeführten Datenverarbeitungen dies erforderlich machen. Wir informieren Sie, sobald durch die Änderungen eine Mitwirkungshandlung Ihrerseits (z.B. Einwilligung) oder eine sonstige individuelle Benachrichtigung erforderlich wird.</p>
    <p></p>
    <h3 class="text-3xl py-4">Kontaktaufnahme</h3>
    <p></p>
    <p>
      <span>
    ...
    <p></p>
    <h3 class="text-3xl py-4">Hosting und E-Mail-Versand</h3>
    <p></p>
    <p>
      <span>
    ...
    <p></p>
    <h3 class="text-3xl py-4">Erhebung von Zugriffsdaten und Logfiles</h3>
    <p></p>
    <p>
      <span>
    ...
    <p></p>
    <h3 class="text-3xl py-4">Google Analytics</h3>
    <p></p>
    <p>
      <span>
        ...
        <br>
        <br>Google wird diese Informationen in unserem Auftrag benutzen, um die Nutzung unseres Onlineangebotes durch die Nutzer auszuwerten, um Reports über die Aktivitäten innerhalb dieses Onlineangebotes zusammenzustellen und um weitere, mit der Nutzung dieses Onlineangebotes und der Internetnutzung verbundene Dienstleistungen, uns gegenüber zu erbringen. Dabei können aus den verarbeiteten Daten pseudonyme Nutzungsprofile der Nutzer erstellt werden.
        <br>
        ...
        <br>
        <br>Soweit Daten in den USA verarbeitet werden, weisen wir daraufhin, dass Google unter dem Privacy-Shield-Abkommen zertifiziert ist und hierdurch zusichert, das europäische Datenschutzrecht einzuhalten (
        <a
          target="_blank"
          href="https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;status=Active"
        >https://www.privacyshield.gov/participant?id=a2zt000000001L5AAI&amp;status=Active</a>).
        <br>
        <br>Weitere Informationen zur Datennutzung durch Google, Einstellungs- und Widerspruchsmöglichkeiten, erfahren Sie in der Datenschutzerklärung von Google (
        <a
          target="_blank"
          href="https://policies.google.com/privacy"
        >https://policies.google.com/privacy</a>) sowie in den Einstellungen für die Darstellung von Werbeeinblendungen durch Google
        <a
          target="_blank"
    ...
    <p></p>
    <h3 class="text-3xl py-4">Onlinepräsenzen in sozialen Medien</h3>
    <p></p>
    <p>
      <span>
        ...
        <br>
        <br>- Facebook, -Seiten, -Gruppen, (Facebook Ireland Ltd., 4 Grand Canal Square, Grand Canal Harbour, Dublin 2, Irland) auf Grundlage einer
        <a
          target="_blank"
          href="https://www.facebook.com/legal/terms/page_controller_addendum"
        >Vereinbarung über gemeinsame Verarbeitung personenbezogener Daten</a> - Datenschutzerklärung:
        <a
          target="_blank"
        ...
        >https://www.facebook.com/legal/terms/information-about-page-insights-data</a> , Opt-Out:
        <a
          target="_blank"
          href="https://www.facebook.com/settings?tab=ads"
        >https://www.facebook.com/settings?tab=ads</a> und
        <a
          target="_blank"
          href="http://www.youronlinechoices.com"
        ...
        <br>
        <br>- Google/ YouTube (Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland) – Datenschutzerklärung: &nbsp;
        <a
          target="_blank"
          href="https://policies.google.com/privacy"
        ...
        >https://www.linkedin.com/psettings/guest-controls/retargeting-opt-out</a>, Privacy Shield:&nbsp;
        <a
          target="_blank"
        ...
        <br>
        <br>- Soundcloud (SoundCloud Limited, Rheinsberger Str. 76/77, 10115 Berlin, Deutschland) - Datenschutzerklärung/ Opt-Out:
        <a
          target="_blank"
